...
function StudentDetailsPage() {
  ...
  // In this case, the student with id 1. The `studentsId` is hard-coded for now.
  // This could be a URL parameter from React Router, e.g. /students/:studentsId
  ...
  //const studentsId = "1";
  const studentProfile = studentsData.find((student) => student._id === studentsId);
