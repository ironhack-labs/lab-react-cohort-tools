...
function StudentDetailsPage() {
  ...
  // In this case, the student with id 1. The `studentParam` is hard-coded for now.
  // This could be a URL parameter from React Router, e.g. /students/:studentParam
  const studentParam = useParams();
  // console.log(studentParam)
  const studentProfile = studentsData.find(
    (student) => student._id == studentParam.studentId
    );
